<div class="row-col" xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
	...
	<div class="col-lg" v-if="providers && providers.length > 0">
		...
		<div class="p-a pos-rlt app-scrollable" v-if="selection.provider && selection.provider.institutions.length > 0 && selection.institution != null" v-bind:style="{height: $root.screen.height - 90 + 'px!important'}" >
